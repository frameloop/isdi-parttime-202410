...
function HomeCustomer() {
    ...
    const handlePhotographerSelect = async (photographerId) => {
        try {
            ...
            const availabilityData = await photographersApi.getAvailability(token, photographerId);
    ...
    const handleDateChange = (date) => {
        ...
        const filteredSlots = availableSlots.filter(slot => slot.date.startsWith(selectedDateStr));
