...
function HomeAdmin() {
    ...
    return (
        <div className="w-screen h-screen bg-white flex flex-col justify-center items-center">
            <h1 className="text-xl font-bold text-black tracking-wider mb-6">Welcome, {name}! (Administrator)</h1>
            <p className="text-black">This is your home page as an administrator.</p>
