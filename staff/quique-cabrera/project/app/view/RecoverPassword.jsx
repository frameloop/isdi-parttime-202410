...
import recoverPassword from '../logic/recoverPassword'; // 👈 Asegúrate de tener esta ruta bien
...
function RecoverPassword() {
    ...
    const handleRecover = async () => {
        try {
            ...
            setSuccessMessage(result.message); // Mensaje: "Check your email for password reset instructions"
        } catch (err) {
    ...
    return (
        <div className="w-screen h-screen bg-[#E1F56E] flex flex-col justify-center items-center">
            ...
            <button
                ...
                disabled={isLoading}
                className="bg-purple-600 text-white px-6 py-3 rounded-lg text-lg font-semibold hover:bg-purple-700 transition-all disabled:opacity-50"
            >
