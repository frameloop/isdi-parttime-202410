class Rasca extends MovableThing {
    constructor() {
        super(document.createElement('div'))

        this.setSize(310, 320)

        const rascaImg = document.createElement('img')
        ...
        const rascaHeadImg = document.createElement('img')
        ...
        const rascaHeadUngryImg = document.createElement('img')
        ...
        const rascaArmImg = document.createElement('img')
